...
import { X, ExternalLink, Clock, Star, Calendar, FileText } from "lucide-react";
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setEstimatedMinutes(Math.max(0, parseInt(e.target.value) || 0))
                  }
                  min={0}
                  className="w-full px-3 py-2.5 rounded-xl border border-[var(--border)] bg-[var(--bg)] text-sm focus:outline-none focus:ring-2 focus:ring-[var(--ring)]"
                />
            ...
            <div className="flex items-center gap-2">
              ...
              {onCreateCourse && (
                <button
                  ...
                  className="px-3 py-2 rounded-xl border border-[var(--border)] text-sm hover:bg-[var(--bg-hover)] transition-colors cursor-pointer"
                >
                  Create
                </button>
              )}
